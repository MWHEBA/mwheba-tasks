...
INSTALLED_APPS = [
    ...
    'settings',  # Using simple name to avoid conflict with backend.settings module
...
MIDDLEWARE = [
    ...
    'backend.middleware.RequestLoggingMiddleware',  # Request logging middleware
]
...
if USE_SQLITE or DEBUG:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'mwheba_tasks'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        # Temporarily allow any for testing - will be restricted in task 6
...
# Explicitly disable allowing all origins for security
...
# Use console-only logging if file logging fails
